...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[0]===`btn${j}`&&all_index_o[2]===`btn${j+2}`&&seqns){
if(boxes[j].innerText===""){boxes[j].innerText="X";
boxes[j].disabled = true;
  dataAddress = boxes[j].getAttribute('data-address');
  turnO = true;
boxes[j].style.color = 'blue';
all_index_x.push(dataAddress);
  seqns=false;
  break;
}}
      if(all_index_x[0]===`btn${j+2}`&&all_index_o[2]===`btn${j}`&&seqns){
if(boxes[j].innerText===""){boxes[j].innerText="X";
boxes[j].disabled = true;
  dataAddress = boxes[j].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[0]===`btn${j+1}`&&all_index_o[2]===`btn${j+2}`&&seqns){
if(boxes[j-1].innerText===""){boxes[j-1].innerText="X";
boxes[j-1].disabled = true;
  dataAddress = boxes[j-1].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
       ...
       if(all_index_x[0]===`btn${j+2}`&&all_index_o[2]===`btn${j+1}`&&seqns){
if(boxes[j-1].innerText===""){boxes[j-1].innerText="X";
boxes[j-1].disabled = true;
  dataAddress = boxes[j-1].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[0]===`btn${j}`&&all_index_o[2]===`btn${j+6}`&&seqns){
if(boxes[j+2].innerText===""){boxes[j+2].innerText="X";
boxes[j+2].disabled = true;
  dataAddress = boxes[j+2].getAttribute('data-address');
  turnO = true;
boxes[j+2].style.color = 'blue';
all_index_x.push(dataAddress);
  seqns=false;
  break;
}}
      
      if(all_index_x[0]===`btn${j+6}`&&all_index_o[2]===`btn${j}`&&seqns){
if(boxes[j+2].innerText===""){boxes[j+2].innerText="X";
boxes[j+2].disabled = true;
  dataAddress = boxes[j+2].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[0]===`btn${j+3}`&&all_index_o[2]===`btn${j+6}`&&seqns){
if(boxes[j-1].innerText===""){boxes[j-1].innerText="X";
boxes[j-1].disabled = true;
  dataAddress = boxes[j-1].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[0]===`btn${j+6}`&&all_index_o[2]===`btn${j+3}`&&seqns){
if(boxes[j-1].innerText===""){boxes[j-1].innerText="X";
boxes[j-1].disabled = true;
  dataAddress = boxes[j-1].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[0]===`btn${5}`&&all_index_o[2]===`btn${9}`&&seqns){
if(boxes[0].innerText===""){boxes[0].innerText="X";
boxes[0].disabled = true;
  dataAddress = boxes[0].getAttribute('data-address');
  turnO = true;
boxes[0].style.color = 'blue';
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[0]===`btn${5}`&&all_index_o[2]===`btn${1}`&&seqns){
if(boxes[8].innerText===""){boxes[8].innerText="X";
boxes[8].disabled = true;
  dataAddress = boxes[8].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[0]===`btn${9}`&&all_index_o[2]===`btn${1}`&&seqns){
if(boxes[4].innerText===""){boxes[4].innerText="X";
boxes[4].disabled = true;
  dataAddress = boxes[4].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[0]===`btn${9}`&&all_index_o[2]===`btn${5}`&&seqns){
if(boxes[0].innerText===""){boxes[0].innerText="X";
boxes[0].disabled = true;
  dataAddress = boxes[0].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[0]===`btn${3}`&&all_index_o[2]===`btn${7}`&&seqns){
if(boxes[4].innerText===""){boxes[4].innerText="X";
boxes[4].disabled = true;
  dataAddress = boxes[4].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[0]===`btn${5}`&&all_index_o[2]===`btn${7}`&&seqns){
if(boxes[2].innerText===""){boxes[2].innerText="X";
boxes[2].disabled = true;
  dataAddress = boxes[2].getAttribute('data-address');
  turnO = true;
boxes[2].style.color = 'blue';
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[0]===`btn${5}`&&all_index_o[2]===`btn${3}`&&seqns){
if(boxes[6].innerText===""){boxes[6].innerText="X";
boxes[6].disabled = true;
  dataAddress = boxes[6].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[0]===`btn${7}`&&all_index_o[2]===`btn${3}`&&seqns){
if(boxes[4].innerText===""){boxes[4].innerText="X";
boxes[4].disabled = true;
  dataAddress = boxes[4].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[0]===`btn${7}`&&all_index_o[2]===`btn${5}`&&seqns){
if(boxes[2].innerText===""){boxes[2].innerText="X";
boxes[2].disabled = true;
  dataAddress = boxes[2].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[1]===`btn${j}`&&all_index_o[2]===`btn${j+2}`&&seqns){
if(boxes[j].innerText===""){boxes[j].innerText="X";
boxes[j].disabled = true;
  dataAddress = boxes[j].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[1]===`btn${j+2}`&&all_index_o[2]===`btn${j}`&&seqns){
if(boxes[j].innerText===""){boxes[j].innerText="X";
boxes[j].disabled = true;
  dataAddress = boxes[j].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[1]===`btn${j+1}`&&all_index_o[2]===`btn${j+2}`&&seqns){
if(boxes[j-1].innerText===""){boxes[j-1].innerText="X";
boxes[j-1].disabled = true;
  dataAddress = boxes[j-1].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
       ...
       if(all_index_x[1]===`btn${j+2}`&&all_index_o[2]===`btn${j+1}`&&seqns){
if(boxes[j-1].innerText===""){boxes[j-1].innerText="X";
boxes[j-1].disabled = true;
  dataAddress = boxes[j-1].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[1]===`btn${j}`&&all_index_o[2]===`btn${j+6}`&&seqns){
if(boxes[j+2].innerText===""){boxes[j+2].innerText="X";
boxes[j+2].disabled = true;
  dataAddress = boxes[j+2].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[1]===`btn${j+6}`&&all_index_o[2]===`btn${j}`&&seqns){
if(boxes[j+2].innerText===""){boxes[j+2].innerText="X";
boxes[j+2].disabled = true;
  dataAddress = boxes[j+2].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[1]===`btn${j+3}`&&all_index_o[2]===`btn${j+6}`&&seqns){
if(boxes[j-1].innerText===""){boxes[j-1].innerText="X";
boxes[j-1].disabled = true;
  dataAddress = boxes[j-1].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
      ...
      if(all_index_x[1]===`btn${j+6}`&&all_index_o[2]===`btn${j+3}`&&seqns){
if(boxes[j-1].innerText===""){boxes[j-1].innerText="X";
boxes[j-1].disabled = true;
  dataAddress = boxes[j-1].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[1]===`btn${5}`&&all_index_o[2]===`btn${9}`&&seqns){
if(boxes[0].innerText===""){boxes[0].innerText="X";
boxes[0].disabled = true;
  dataAddress = boxes[0].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[1]===`btn${5}`&&all_index_o[2]===`btn${1}`&&seqns){
if(boxes[8].innerText===""){boxes[8].innerText="X";
boxes[8].disabled = true;
  dataAddress = boxes[8].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[1]===`btn${9}`&&all_index_o[2]===`btn${1}`&&seqns){
if(boxes[4].innerText===""){boxes[4].innerText="X";
boxes[4].disabled = true;
  dataAddress = boxes[4].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[1]===`btn${9}`&&all_index_o[2]===`btn${5}`&&seqns){
if(boxes[0].innerText===""){boxes[0].innerText="X";
boxes[0].disabled = true;
  dataAddress = boxes[0].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[1]===`btn${5}`&&all_index_o[2]===`btn${7}`&&seqns){
if(boxes[2].innerText===""){boxes[2].innerText="X";
boxes[2].disabled = true;
  dataAddress = boxes[2].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[1]===`btn${5}`&&all_index_o[2]===`btn${3}`&&seqns){
if(boxes[6].innerText===""){boxes[6].innerText="X";
boxes[6].disabled = true;
  dataAddress = boxes[6].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[1]===`btn${7}`&&all_index_o[2]===`btn${3}`&&seqns){
if(boxes[4].innerText===""){boxes[4].innerText="X";
boxes[4].disabled = true;
  dataAddress = boxes[4].getAttribute('data-address');
  turnO = true;
...
all_index_x.push(dataAddress);
  ...
  break;
   ...
   if(all_index_x[1]===`btn${7}`&&all_index_o[2]===`btn${5}`&&seqns){
if(boxes[2].innerText===""){boxes[2].innerText="X";
boxes[2].disabled = true;
  dataAddress = boxes[2].getAttribute('data-address');
  turnO = true;
...
if(all_index_o[0]==="btn5"){
  const numbers = [0, 2, 6, 8];
